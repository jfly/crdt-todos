/**
 * Environment variables for the `todos-service-common` package, including inherited variables.
...
export interface TodosServiceCommonEnvSchema {
  /**
  ...
  TODOS_SERVICE_HOST: string;
  TODOS_SERVICE_HTTP_PORT: string;
  /**
...
/**
 * `process.env` casted to the `TodosServiceCommonEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TodosServiceCommonEnvSchema;
