/**
 * Environment variables for the `todos-service` package, including inherited variables.
...
export interface TodosServiceEnvSchema {
  /**
...
/**
 * `process.env` casted to the `TodosServiceEnvSchema` type.
 */
export const typedEnv = (globalThis.process ? process.env : {}) as unknown as TodosServiceEnvSchema;
